...
class MpiAdam(object):
    ...
    def update(self, local_grad, learning_rate):
        ...
        try:
            ...
            print(f'global_grad is: {global_grad}')
            print(f'self.comm.Get_size() is: {self.comm.Get_size()}')
            print(f'self.beta1 is: {self.beta1}')
            print(f'self.beta2 is: {self.beta2}')
            print(f'self.exp_avg is: {self.exp_avg}')
            raise
